...
<head>
  ...
  <title>Pizzaria QueroMais Template - Index</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-lg-0">
        ...
        <h1>Pizzaria <span>QueroMais.</span></h1>
      </a>
    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          ...
          <p data-aos="fade-up" data-aos-delay="100">A pizzaria QueroMais conta com uma variedade de mais de 40 sabores para você!</p>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="#book-a-table" class="btn-book-a-table">Book a Table</a>
          </div>
        </div>
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="assets/img/pizza.jpg" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
    </div>
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <?php $query = retornaDados() ; while ($dados = $query->fetch_array()) { ?>
                ...
                <div class="col-lg-4 menu-item">
                  <a href="assets/img/menu/menu-item-1.png" class="glightbox"><img src="https://<?php echo $dados['imagem']; ?>" class="menu-img img-fluid" alt=""></a>
      ...
      <div class="row gy-3">
        ...
        <div class="col-lg-3 col-md-6 footer-links d-flex">
          ...
          <div>
            <h4>Reservas</h4>
            <p>
              <strong>Phone:</strong> (75) 9 6265-2300<br>
              <strong>Email:</strong> QueroMais@gmail.com<br>
            </p>
          </div>
        </div>
